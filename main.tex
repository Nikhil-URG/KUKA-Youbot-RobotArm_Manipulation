...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{small.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{large.png}
...
Data from each group was standardized to common units (cm for positions, radians for orientations) and merged based on timestamps with a 10-minute tolerance. The combined dataset includes trials from all groups, sizes, and directions, providing a total of [placeholder: total trials] experimental runs.

The combined preprocessed data is available at: \href{https://github.com/username/repo/blob/main/combined_preprocessed_data.csv}{combined_preprocessed_data.csv}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{combined_small.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{combined_medium.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{combined_large.png}
...
The mean distances between internal and external measurements across all groups range from [placeholder: min] cm to [placeholder: max] cm. This combined analysis shows [placeholder: observations about accuracy].

\paragraph{Precision (Combined):}
The standard deviations of external positions across all groups are [placeholder: range] cm, indicating [placeholder: observations about precision].
...
\begin{table}[H]
\centering
\caption{Combined Accuracy and Precision by Group}
\label{tab:combined_stats}
\begin{tabular}{|c|c|c|c|}
\hline
Group & Object Size & Accuracy (cm) & Precision (cm) \\
\hline
Group 1 & Small & [placeholder] & [placeholder] \\
Group 1 & Medium & [placeholder] & [placeholder] \\
Group 1 & Large & [placeholder] & [placeholder] \\
Group 2 & Small & [placeholder] & [placeholder] \\
Group 2 & Medium & [placeholder] & [placeholder] \\
Group 2 & Large & [placeholder] & [placeholder] \\
Group 3 & Small & [placeholder] & [placeholder] \\
Group 3 & Medium & [placeholder] & [placeholder] \\
Group 3 & Large & [placeholder] & [placeholder] \\
Group 4 & Small & [placeholder] & [placeholder] \\
Group 4 & Medium & [placeholder] & [placeholder] \\
Group 4 & Large & [placeholder] & [placeholder] \\
\hline
\end{tabular}
\end{table}
...
The combined analysis across all groups demonstrates [placeholder: overall conclusions]. Variations between groups may be attributed to differences in experimental setup, calibration, or environmental factors. This comprehensive evaluation provides a more robust assessment of the youBot arm's capabilities.
